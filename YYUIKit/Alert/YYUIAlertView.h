...
@property (nullable, nonatomic, readonly) YYUIPopupController *popupController;
...
@property (nonatomic, assign) CGFloat maxHeight;            // Default is SCREENHEIGHT.
@property (nonatomic, assign) UIEdgeInsets misEdgeInset;    // Default is 275.
...
@property (nonatomic, strong) UIColor *buttonDefaultColor;  // Default is #333333. effect with MMItemTypeNormal
@property (nonatomic, strong) UIColor *buttonCancelColor;   // Default is #E76153. effect with MMItemTypeHighlight
