//
//  YYUIActivityIndicatorThreeDotsFadeAnimation.m
//  YYUIActivityIndicatorView
//
...
@implementation YYUIActivityIndicatorThreeDotsFadeAnimation
- (void)setupAnimationInLayer:(CALayer *)layer withSize:(CGSize)size tintColor:(UIColor *)tintColor {
    CGFloat duration = 0.7f;
    NSArray *beginTimes = @[@0.35f, @0.125f, @0.0f];
