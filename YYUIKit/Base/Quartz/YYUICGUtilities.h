...
floorInPixel(CGFloat floatValue) {
    floatValue = removeFloatMin(floatValue);
    CGFloat resultValue = floor(floatValue * YYScreenScale()) / YYScreenScale();
    return resultValue;
}
...
CG_INLINE BOOL
CGFloatEqual(CGFloat a, CGFloat b) {
...
CG_INLINE BOOL
UIEdgeInsetsEqual(UIEdgeInsets insets1, UIEdgeInsets insets2) {
