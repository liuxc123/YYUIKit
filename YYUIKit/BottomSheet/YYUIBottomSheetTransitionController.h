//
//  YYUIBottomSheetTransitionController.h
//  YYUIKit
//
...
/**
 YYUIBottomSheetTransitionController is be used to setup a custom transition and animationed
...
@interface YYUIBottomSheetTransitionController (ScrimAccessibility)
