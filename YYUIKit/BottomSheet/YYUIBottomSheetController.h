 ...
 */
@property(nonatomic, readonly) YYUIBottomSheetState state;
...
- (void)setShapeGenerator:(nullable id<YYUIShapeGenerating>)shapeGenerator
                 forState:(YYUIBottomSheetState)state;

/**
 Returns the shape generator for an YYUIBottomSheetState state.

 @param state The state of the bottom sheet
 @return the shape generator for the state given.
 */
- (nullable id<YYUIShapeGenerating>)shapeGeneratorForState:(YYUIBottomSheetState)state;
