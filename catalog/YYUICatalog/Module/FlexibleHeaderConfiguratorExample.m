//
//  FlexibleHeaderConfiguratorExample.m
//  YYUICatalog
//
...
: UITableViewController <YYUIFlexibleHeaderViewLayoutDelegate>
...
#pragma mark - YYUIFlexibleHeaderViewLayoutDelegate

- (void)flexibleHeaderViewController:(YYUIFlexibleHeaderViewController *)flexibleHeaderViewController
    flexibleHeaderViewFrameDidChange:(YYUIFlexibleHeaderView *)flexibleHeaderView {
...
- (void)field:(FlexibleHeaderConfiguratorField)field didChangeValue:(NSNumber *)value {
    YYUIFlexibleHeaderView *headerView = self.fhvc.headerView;
    switch (field) {
            // Basic behavior
        ...
        case FlexibleHeaderConfiguratorFieldShiftBehaviorEnabled: {
            ...
            if (!isOn) {
                headerView.shiftBehavior = YYUIFlexibleHeaderShiftBehaviorDisabled;
                [self
                 didChangeValueForField:FlexibleHeaderConfiguratorFieldShiftBehaviorEnabledWithStatusBar
                 animated:YES];
            } else {
                headerView.shiftBehavior = YYUIFlexibleHeaderShiftBehaviorEnabled;
        ...
        case FlexibleHeaderConfiguratorFieldShiftBehaviorEnabledWithStatusBar: {
            ...
            if (!isOn) {
                ...
                headerView.shiftBehavior = YYUIFlexibleHeaderShiftBehaviorEnabledWithStatusBar;
        ...
        case FlexibleHeaderConfiguratorFieldShiftBehaviorHideable: {
            ...
            if (!isOn) {
                ...
                headerView.shiftBehavior = YYUIFlexibleHeaderShiftBehaviorHideable;
                [self didChangeValueForField:FlexibleHeaderConfiguratorFieldShiftBehaviorEnabled
                                    animated:YES];
                [self
                 didChangeValueForField:FlexibleHeaderConfiguratorFieldShiftBehaviorEnabledWithStatusBar
        ...
        case FlexibleHeaderConfiguratorFieldContentImportance:
            ...
            ([value boolValue] ? YYUIFlexibleHeaderContentImportanceHigh
...
// Required for shiftBehavior == YYUIFlexibleHeaderShiftBehaviorEnabledWithStatusBar.
...
- (NSNumber *)valueForField:(FlexibleHeaderConfiguratorField)field {
    switch (field) {
        ...
        case FlexibleHeaderConfiguratorFieldContentImportance:
            return @(
            (self.fhvc.headerView.headerContentImportance == YYUIFlexibleHeaderContentImportanceHigh));
            
        case FlexibleHeaderConfiguratorFieldHideStatusBar:
            return @(self.overrideStatusBarHidden);
            
        case FlexibleHeaderConfiguratorFieldShiftBehaviorEnabled: {
            YYUIFlexibleHeaderShiftBehavior behavior = self.fhvc.headerView.shiftBehavior;
            BOOL enabled = (behavior == YYUIFlexibleHeaderShiftBehaviorEnabled ||
        ...
        case FlexibleHeaderConfiguratorFieldShiftBehaviorEnabledWithStatusBar: {
            YYUIFlexibleHeaderShiftBehavior behavior = self.fhvc.headerView.shiftBehavior;
            BOOL enabled = (behavior == YYUIFlexibleHeaderShiftBehaviorEnabledWithStatusBar);
            return @(enabled);
        }
            
        case FlexibleHeaderConfiguratorFieldShiftBehaviorHideable: {
            YYUIFlexibleHeaderShiftBehavior behavior = self.fhvc.headerView.shiftBehavior;
            BOOL enabled = (behavior == YYUIFlexibleHeaderShiftBehaviorHideable);
            return @(enabled);
        }
...
- (instancetype)initWithStyle:(UITableViewStyle)style {
    ...
    if (self) {
        self.fhvc = [[YYUIFlexibleHeaderViewController alloc] initWithNibName:nil bundle:nil];
