//
//  YYUIFlexibleHeaderContainerViewController.m
//  CatalogByConvention
//
...
@implementation YYUIFlexibleHeaderContainerViewController

- (instancetype)initWithContentViewController:(UIViewController *)contentViewController {
  self = [super initWithNibName:nil bundle:nil];
  if (self) {
    _headerViewController = [[YYUIFlexibleHeaderViewController alloc] init];
