//
//  YYUIFlexibleHeaderViewController.h
//  CatalogByConvention
//
...
@protocol YYUIFlexibleHeaderViewLayoutDelegate;
@protocol YYUIFlexibleHeaderSafeAreaDelegate;

/**
 The YYUIFlexibleHeaderViewController controller is a simple UIViewController-oriented interface
...
/**
 A block that is invoked when the @c YYUIFlexibleHeaderViewController receives a call to @c
 traitCollectionDidChange:. The block is called after the call to the superclass.
 */
@property(nonatomic, copy, nullable) void (^traitCollectionDidChangeBlock)
    (YYUIFlexibleHeaderViewController *_Nonnull flexibleHeaderViewController,
     UITraitCollection *_Nullable previousTraitCollection);

/** The layout delegate will be notified of any changes to the flexible header view's frame. */
@property(nonatomic, weak, nullable) id<YYUIFlexibleHeaderViewLayoutDelegate> layoutDelegate;

/** The safe area delegate can be queried for the correct way to calculate safe areas. */
@property(nonatomic, weak, nullable) id<YYUIFlexibleHeaderSafeAreaDelegate> safeAreaDelegate;
...
/**
 ...
 simple container view controller or by using YYUIFlexibleHeaderContainerViewController. This
