...
typedef void (^YYUIFlexibleHeaderChangeContentInsetsBlock)(void);
typedef void (^YYUIFlexibleHeaderShadowIntensityChangeBlock)(__kindof CALayer *_Nonnull shadowLayer,
                                                            CGFloat intensity);

/** Mutually exclusive phases that the flexible header view can be in. */
typedef NS_ENUM(NSInteger, YYUIFlexibleHeaderScrollPhase) {
   ...
   */
  YYUIFlexibleHeaderScrollPhaseShifting,
   ...
   */
  YYUIFlexibleHeaderScrollPhaseCollapsing,
  ...
  /**
   ...
   frame.size.height is changing.
   */
  YYUIFlexibleHeaderScrollPhaseOverExtending,
};

@protocol YYUIFlexibleHeaderViewAnimationDelegate;
@protocol YYUIFlexibleHeaderViewDelegate;

/**
 YYUIFlexibleHeaderView tracks the content offset of a scroll view and adjusts its size and
 ...
 */
IB_DESIGNABLE
@interface YYUIFlexibleHeaderView : UIView <YYUIElevatable, YYUIElevationOverriding>
...
- (void)setShadowLayer:(nonnull __kindof CALayer *)shadowLayer
    intensityDidChangeBlock:(nonnull YYUIFlexibleHeaderShadowIntensityChangeBlock)block;
 ...
 */
- (void)changeContentInsets:(nonnull YYUIFlexibleHeaderChangeContentInsetsBlock)block;
 ...
 */
@property(nonatomic, readonly) YYUIFlexibleHeaderScrollPhase scrollPhase;
...
/**
 ...
 YYUIFlexibleHeaderShiftBehaviorDisabled, an assertion will be thrown. If you intend to use any
...
@property(nonatomic, weak, nullable) id<YYUIFlexibleHeaderViewDelegate> delegate;

/** The animation delegate will be notified of any animations to the flexible header view. */
@property(nonatomic, weak, nullable) id<YYUIFlexibleHeaderViewAnimationDelegate> animationDelegate;
...
@property(nonatomic, copy, nullable) void (^traitCollectionDidChangeBlock)
    (YYUIFlexibleHeaderView *_Nonnull flexibleHeaderView,
...
@interface YYUIFlexibleHeaderView (ToBeDeprecated)
