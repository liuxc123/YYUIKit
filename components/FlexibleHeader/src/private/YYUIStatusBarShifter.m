...
- (instancetype)init {
    ...
    if (self) {
        ...
        _originalStatusBarHeight = [UIApplication yyui_safeSharedApplication].statusBarFrame.size.height;
...
- (BOOL)canUpdateStatusBarFrame {
    CGRect statusBarFrame = [[UIApplication yyui_safeSharedApplication] statusBarFrame];
