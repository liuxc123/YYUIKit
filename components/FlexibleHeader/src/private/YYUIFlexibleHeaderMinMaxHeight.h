//
//  YYUIFlexibleHeaderMinMaxHeight.h
//  YYUIKit
//
...
@protocol YYUIFlexibleHeaderMinMaxHeightDelegate;

/**
 Manages the height behavior for YYUIFlexibleHeaderView.
 
 In an ideal configuration, minMaxHeightIncludesSafeArea is disabled and the behavior of this class
 is as follows.
 
 minimumHeight and maximumHeight define the lower and upper bounds of YYUIFlexibleHeaderView
 ...
 */
__attribute__((objc_subclassing_restricted)) @interface YYUIFlexibleHeaderMinMaxHeight : NSObject
 ...
 */
- (nonnull instancetype)initWithTopSafeArea:(nonnull YYUIFlexibleHeaderTopSafeArea *)topSafeArea
NS_DESIGNATED_INITIALIZER;

#pragma mark Configuring the minimum and maximum height

/**
 See YYUIFlexibleHeaderView.h for complete documentation of this property.
 */
 ...
 */
@property(nonatomic, weak, nullable) id<YYUIFlexibleHeaderMinMaxHeightDelegate> delegate;
...
@interface YYUIFlexibleHeaderMinMaxHeight (ToBeDeprecated)
