...
@implementation YYUIShapedShadowLayer

- (instancetype)init {
  self = [super init];
  if (self) {
    [self commonYYUIShapedShadowLayerInit];
  }
  return self;
}
...
- (instancetype)initWithLayer:(id)layer {
  ...
  if (self && [self isKindOfClass:[YYUIShapedShadowLayer class]]) {
    YYUIShapedShadowLayer *otherLayer = (YYUIShapedShadowLayer *)layer;
...
- (void)commonYYUIShapedShadowLayerInit {
...
- (void)setShapedBackgroundColor:(UIColor *)shapedBackgroundColor {
  ...
  if ([self.delegate isKindOfClass:[UIView class]]) {
    ...
    _shapedBackgroundColor =
        [_shapedBackgroundColor yyui_resolvedColorWithTraitCollection:view.traitCollection];
  }
...
- (void)setShapedBorderColor:(UIColor *)shapedBorderColor {
  ...
  if ([self.delegate isKindOfClass:[UIView class]]) {
    UIView *view = (UIView *)self.delegate;
    _shapedBorderColor =
        [_shapedBorderColor yyui_resolvedColorWithTraitCollection:view.traitCollection];
  }
  if (CGPathIsEmpty(self.path)) {
