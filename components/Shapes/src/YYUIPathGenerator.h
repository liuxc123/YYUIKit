...
/**
 YYUIPathGenerator is a factory for creating CGPaths. Describe your path with the
 lineTo and addArc... methods, then call appendToCGPath to append them to a
 CGPath.

 @note YYUIPathGenerators always start at (0, 0) and end at @c endPoint.
 */
@interface YYUIPathGenerator : NSObject
...
/**
 Returns an initialized YYUIPathGenerator instance with a startPoint of CGPointZero.
 */
+ (nonnull instancetype)pathGenerator;

/**
 Returns an initialized YYUIPathGenerator instance.
