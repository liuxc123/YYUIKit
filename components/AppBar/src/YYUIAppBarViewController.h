...
/**
 The YYUIAppBar class creates and configures the constellation of components required to represent a
 Material App Bar.
 ...
 @warning This API will be deprecated in favor of YYUIAppBarViewController. Learn more at
...
/** The navigation bar. */
@property(nonatomic, strong, nonnull, readonly) YYUINavigationBar *navigationBar;

/**
 The header stack view that owns the navigationBar (as the top bar) and an optional bottom bar.
 */
@property(nonatomic, strong, nonnull, readonly) YYUIHeaderStackView *headerStackView;
...
/**
 ...
 See YYUIFlexibleHeaderViewController's documentation for the API of the same name.
