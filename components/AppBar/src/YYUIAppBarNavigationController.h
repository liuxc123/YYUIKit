//
//  YYUIAppBarNavigationController.h
//  YYUIKit
//
 ...
 */
@protocol
    YYUIAppBarNavigationControllerDelegate <UINavigationControllerDelegate>
@optional
...
/**
 ...
 be invoked.
 */
- (void)appBarNavigationController:(nonnull YYUIAppBarNavigationController *)navigationController
       willAddAppBarViewController:(nonnull YYUIAppBarViewController *)appBarViewController
...
- (nullable UIScrollView *)appBarNavigationController:
                               (nonnull YYUIAppBarNavigationController *)navigationController
 ...
 */
__attribute__((objc_subclassing_restricted)) @interface YYUIAppBarNavigationController
 ...
 */
@property(nonatomic, weak, nullable) id<YYUIAppBarNavigationControllerDelegate> delegate;
...
/**
 ...
 injected.
 */
- (nullable YYUIAppBarViewController *)appBarViewControllerForViewController:
    (nonnull UIViewController *)viewController;

/**
 A block that is assigned to each injected @c YYUIAppBarViewController's
 @c traitCollectionDidChangeBlock property. The block will be executed when the injected
 @c YYUIAppBarViewController's @c -traitCollectionDidChange: is called.
 */
