...
NSString *const YYUIKeyboardWatcherKeyboardWillShowNotification =
    @"YYUIKeyboardWatcherKeyboardWillShowNotification";
NSString *const YYUIKeyboardWatcherKeyboardWillHideNotification =
    @"YYUIKeyboardWatcherKeyboardWillHideNotification";
NSString *const YYUIKeyboardWatcherKeyboardWillChangeFrameNotification =
    @"YYUIKeyboardWatcherKeyboardWillChangeFrameNotification";

static YYUIKeyboardWatcher *_sKeyboardWatcher;

@interface YYUIKeyboardWatcher ()
...
@implementation YYUIKeyboardWatcher
...
+ (void)load {
  @autoreleasepool {
    _sKeyboardWatcher = [[YYUIKeyboardWatcher alloc] init];
  }
}
...
- (void)updateKeyboardOffsetWithKeyboardUserInfo:(NSDictionary *)userInfo {
  ...
  CGRect keyWindowBounds = [UIApplication yyui_safeSharedApplication].keyWindow.bounds;
...
+ (NSTimeInterval)animationDurationFromKeyboardNotification:(NSNotification *)notification {
  if (![notification.name isEqualToString:YYUIKeyboardWatcherKeyboardWillShowNotification] &&
      ![notification.name isEqualToString:YYUIKeyboardWatcherKeyboardWillHideNotification] &&
      ![notification.name isEqualToString:YYUIKeyboardWatcherKeyboardWillChangeFrameNotification]) {
...
- (void)keyboardWillShow:(NSNotification *)notification {
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:YYUIKeyboardWatcherKeyboardWillShowNotification
                    object:self
...
- (void)keyboardWillChangeFrame:(NSNotification *)notification {
  [self updateKeyboardOffsetWithKeyboardUserInfo:notification.userInfo];
  [[NSNotificationCenter defaultCenter]
      postNotificationName:YYUIKeyboardWatcherKeyboardWillChangeFrameNotification
                    object:self
                  userInfo:notification.userInfo];
}
...
- (void)keyboardWillHide:(NSNotification *)notification {
  ...
  self.keyboardFrame = CGRectZero;
  [[NSNotificationCenter defaultCenter]
      postNotificationName:YYUIKeyboardWatcherKeyboardWillHideNotification
                    object:self
                  userInfo:notification.userInfo];
}
