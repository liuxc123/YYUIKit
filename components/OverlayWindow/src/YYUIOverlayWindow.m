...
/**
 ...
 Used by YYUIOverlayWindow, overlay views are added to the overlay window container when
 @c activateOverlay is called and removed from the overlay window when @c deactivateOverlay is
 called.
 */
@interface YYUIOverlayWindowContainerView : UIView
@end

@interface YYUIOverlayWindow ()

@property(nonatomic, strong) NSMutableArray *overlays;
@property(nonatomic, strong) YYUIOverlayWindowContainerView *overlayView;

// Forward declaration so that YYUIOverlayWindowContainerView can call this method.
- (void)noteOverlayRemoved:(UIView *)overlay;

@end

@implementation YYUIOverlayWindowContainerView

- (void)willRemoveSubview:(UIView *)subview {
    [super willRemoveSubview:subview];
    
    YYUIOverlayWindow *window = (YYUIOverlayWindow *)self.window;
...
@implementation YYUIOverlayWindow
...
- (void)commonInit {
    ...
    _overlayView = [[YYUIOverlayWindowContainerView alloc] initWithFrame:self.bounds];
