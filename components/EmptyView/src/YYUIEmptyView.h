 ...
 */
@interface YYUIEmptyView : UIView

@property(nonatomic, strong) UIView<YYUIEmptyViewLoadingViewProtocol> *loadingView;   // 此控件通过设置 loadingView.hidden 来控制 loadinView 的显示和隐藏，因此请确保你的loadingView 没有类似于 hidesWhenStopped = YES 之类会使 view.hidden 失效的属性

@property(nonatomic, strong, readonly) UIImageView *imageView;
@property(nonatomic, strong, readonly) UILabel *textLabel;
@property(nonatomic, strong, readonly) UILabel *detailTextLabel;
@property(nonatomic, strong, readonly) YYUIButton *actionButton;
...
/**
 *  如果要继承YYUIEmptyView并添加新的子 view，则必须：
