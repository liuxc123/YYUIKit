...
NSString * _Nonnull const YYUIAlertViewWillShowNotification = @"YYUIAlertViewWillShowNotification";
NSString * _Nonnull const YYUIAlertViewDidShowNotification  = @"YYUIAlertViewDidShowNotification";

NSString * _Nonnull const YYUIAlertViewWillDismissNotification = @"YYUIAlertViewWillDismissNotification";
NSString * _Nonnull const YYUIAlertViewDidDismissNotification  = @"YYUIAlertViewDidDismissNotification";

NSString * _Nonnull const YYUIAlertViewActionNotification      = @"YYUIAlertViewActionNotification";
NSString * _Nonnull const YYUIAlertViewCancelNotification      = @"YYUIAlertViewCancelNotification";
NSString * _Nonnull const YYUIAlertViewDestructiveNotification = @"YYUIAlertViewDestructiveNotification";

NSString * _Nonnull const YYUIAlertViewDidDismissAfterActionNotification      = @"YYUIAlertViewDidDismissAfterActionNotification";
NSString * _Nonnull const YYUIAlertViewDidDismissAfterCancelNotification      = @"YYUIAlertViewDidDismissAfterCancelNotification";
NSString * _Nonnull const YYUIAlertViewDidDismissAfterDestructiveNotification = @"YYUIAlertViewDidDismissAfterDestructiveNotification";

NSString * _Nonnull const YYUIAlertViewShowAnimationsNotification    = @"YYUIAlertViewShowAnimationsNotification";
NSString * _Nonnull const YYUIAlertViewDismissAnimationsNotification = @"YYUIAlertViewDismissAnimationsNotification";

NSString * _Nonnull const kYYUIAlertViewAnimationDuration = @"duration";

#pragma mark - Types

typedef enum {
    YYUIAlertViewTypeDefault           = 0,
    YYUIAlertViewTypeActivityIndicator = 1,
    YYUIAlertViewTypeProgressView      = 2,
    YYUIAlertViewTypeTextFields        = 3
}
YYUIAlertViewType;

#pragma mark - Interface

@interface YYUIAlertView () <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, UIGestureRecognizerDelegate>

@property (readwrite) BOOL             showing;
@property (readwrite) YYUIAlertViewStyle style;
...
@property (strong, nonatomic) YYUIAlertViewButton *destructiveButton;
...
@property (assign, nonatomic) YYUIAlertViewType type;
...
@property (copy, nonatomic) YYUIAlertViewTextFieldsSetupHandler textFieldsSetupHandler;
...
- (nonnull instancetype)initWithTitle:(nullable NSString *)title
                              message:(nullable NSString *)message
                                style:(YYUIAlertViewStyle)style
...
- (nonnull instancetype)initWithActivityIndicatorAndTitle:(nullable NSString *)title
    ...
    if (self) {
        self.style = style;
        self.type = YYUIAlertViewTypeActivityIndicator;
        self.title = title;
        self.message = message;
        self.buttonTitles = buttonTitles.mutableCopy;
        self.cancelButtonTitle = cancelButtonTitle;
...
- (nonnull instancetype)initWithProgressViewAndTitle:(nullable NSString *)title
    ...
    if (self) {
        self.style = style;
        self.type = YYUIAlertViewTypeProgressView;
        self.title = title;
        self.message = message;
        self.buttonTitles = buttonTitles.mutableCopy;
        self.cancelButtonTitle = cancelButtonTitle;
...
- (nonnull instancetype)initWithTextFieldsAndTitle:(nullable NSString *)title
                            ...
                            textFieldsSetupHandler:(YYUIAlertViewTextFieldsSetupHandler)textFieldsSetupHandler
                                      buttonTitles:(nullable NSArray<NSString *> *)buttonTitles
                                 cancelButtonTitle:(nullable NSString *)cancelButtonTitle
                            destructiveButtonTitle:(nullable NSString *)destructiveButtonTitle {
    self = [super init];
    if (self) {
        self.style = YYUIAlertViewStyleAlert;
        self.type = YYUIAlertViewTypeTextFields;
        self.title = title;
        self.message = message;
...
- (nonnull instancetype)initWithTitle:(nullable NSString *)title
                    ...
                    cancelButtonTitle:(nullable NSString *)cancelButtonTitle
               destructiveButtonTitle:(nullable NSString *)destructiveButtonTitle
                        actionHandler:(YYUIAlertViewActionHandler)actionHandler
                        cancelHandler:(YYUIAlertViewHandler)cancelHandler
                   destructiveHandler:(YYUIAlertViewHandler)destructiveHandler {
...
- (nonnull instancetype)initWithTitle:(nullable NSString *)title
                    ...
                    cancelButtonTitle:(nullable NSString *)cancelButtonTitle
               destructiveButtonTitle:(nullable NSString *)destructiveButtonTitle
                             delegate:(nullable id<YYUIAlertViewDelegate>)delegate {
    self = [self initWithTitle:title
                       message:message
                         style:style
                  buttonTitles:buttonTitles
...
- (nonnull instancetype)initAsAppearance {
    ...
    if (self) {
        ...
        _windowLevel = YYUIAlertViewWindowLevelAboveStatusBar;
...
- (void)setupDefaults {
    ...
    YYUIAlertView *appearance = [YYUIAlertView appearance];
    ...
    if (appearance.isUserCancelOnTouch) {
        ...
        _cancelOnTouch = self.type != YYUIAlertViewTypeActivityIndicator && self.type != YYUIAlertViewTypeProgressView && self.type != YYUIAlertViewTypeTextFields;
    }
    ...
    if (appearance.isUserButtonsHeight) {
        ...
        _buttonsHeight = (self.style == YYUIAlertViewStyleAlert || YYUIAlertViewHelper.systemVersion < 9.0) ? 44.0 : 56.0;
    }
    ...
    if (appearance.isUserTitleTextColor) {
        ...
        _titleTextColor = self.style == YYUIAlertViewStyleAlert ? UIColor.blackColor : UIColor.grayColor;
    }
    ...
    if (appearance.isUserTitleFont) {
        ...
        _titleFont = [UIFont boldSystemFontOfSize:self.style == YYUIAlertViewStyleAlert ? 18.0 : 14.0];
    }
    ...
    if (appearance.isUserMessageTextColor) {
        ...
        _messageTextColor = self.style == YYUIAlertViewStyleAlert ? UIColor.blackColor : UIColor.grayColor;
    }
    ...
    self.viewController = [[YYUIAlertViewController alloc] initWithAlertView:self view:self.view];
...
- (void)dealloc {
    ...
    NSLog(@"YYUIAlertView DEALLOCATED");
#endif
}
...
+ (instancetype)sharedAlertViewForAppearance {
    static YYUIAlertView *alertView;
    static dispatch_once_t onceToken;

    dispatch_once(&onceToken, ^{
        alertView = [[YYUIAlertView alloc] initAsAppearance];
    });
...
- (BOOL)textFieldShouldReturn:(YYUIAlertViewTextField *)textField {
    if (textField.returnKeyType == UIReturnKeyNext) {
        if (self.textFieldsArray.count > textField.tag + 1) {
            YYUIAlertViewTextField *nextTextField = self.textFieldsArray[textField.tag + 1];
...
- (void)setProgress:(float)progress {
    if (self.type != YYUIAlertViewTypeProgressView) return;
...
- (void)setProgressLabelText:(nullable NSString *)progressLabelText {
    if (self.type != YYUIAlertViewTypeProgressView && self.type != YYUIAlertViewTypeActivityIndicator) return;
...
- (void)setCancelButtonEnabled:(BOOL)cancelButtonEnabled {
    ...
    if (self.cancelButtonTitle) {
        if (self.tableView) {
            YYUIAlertViewCell *cell = (YYUIAlertViewCell *)[self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:(self.buttonTitles.count - 1) inSection:0]];
...
- (void)setDestructiveButtonEnabled:(BOOL)destructiveButtonEnabled {
    ...
    if (self.destructiveButtonTitle) {
        if (self.tableView) {
            YYUIAlertViewCell *cell = (YYUIAlertViewCell *)[self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]];
...
- (CGFloat)width {
    CGSize size = YYUIAlertViewHelper.appWindow.bounds.size;
    ...
    if (self.style == YYUIAlertViewStyleAlert || [YYUIAlertViewHelper isPadAndNotForceForAlertView:self]) {
        return 280.0; // 320.0 - (20.0 * 2.0)
    }

    if (YYUIAlertViewHelper.isPad) {
...
- (void)setDelegate:(id<YYUIAlertViewDelegate>)delegate {
    _delegate = delegate;
...
- (void)setButtonEnabled:(BOOL)enabled atIndex:(NSUInteger)index {
    ...
    if (self.tableView) {
        ...
        YYUIAlertViewCell *cell = (YYUIAlertViewCell *)[self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:index inSection:0]];
...
- (void)setButtonPropertiesAtIndex:(NSUInteger)index
                           handler:(void(^ _Nonnull)(YYUIAlertViewButtonProperties * _Nonnull properties))handler {
    ...
    YYUIAlertViewButtonProperties *properties = self.buttonsPropertiesDictionary[@(index)];

    if (!properties) {
        properties = [YYUIAlertViewButtonProperties new];
    }
...
- (void)configCell:(YYUIAlertViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.destructiveButtonTitle && indexPath.row == 0) {
    ...
    else if (self.cancelButtonTitle && ![YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self] && indexPath.row == self.buttonTitles.count - 1) {
        ...
        YYUIAlertViewButtonProperties *properties = nil;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else if (self.cancelButtonTitle && indexPath.row == self.buttonTitles.count - 1 && ![YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self]) {
        [self cancelAction:nil];
    }
    else {
...
- (void)showAnimated:(BOOL)animated completionHandler:(YYUIAlertViewCompletionHandler)completionHandler {
...
- (void)showAnimated:(BOOL)animated hidden:(BOOL)hidden completionHandler:(YYUIAlertViewCompletionHandler)completionHandler {
    if (!self.isValid || self.isShowing) return;

    self.window.windowLevel = UIWindowLevelStatusBar + (self.windowLevel == YYUIAlertViewWindowLevelAboveStatusBar ? 1 : -1);
    ...
    if (hidden) {
        ...
        if ([YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self]) {
    ...
    if (animated) {
        [YYUIAlertViewHelper
         ...
         animations:^(void) {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewShowAnimationsNotification
                                                                 object:self
                                                               userInfo:@{kYYUIAlertViewAnimationDuration: @(self.animationDuration)}];
...
- (void)showAnimations {
    ...
    if ([YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self] && self.cancelButton) {
...
- (void)showComplete {
    if (self.type == YYUIAlertViewTypeTextFields && self.textFieldsArray.count) {
...
- (void)dismissAnimated:(BOOL)animated completionHandler:(YYUIAlertViewCompletionHandler)completionHandler {
    ...
    if (animated) {
        [YYUIAlertViewHelper
         ...
         animations:^(void) {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewDismissAnimationsNotification
                                                                 object:self
                                                               userInfo:@{kYYUIAlertViewAnimationDuration: @(self.animationDuration)}];
...
- (void)transitionToAlertView:(nonnull YYUIAlertView *)alertView completionHandler:(YYUIAlertViewCompletionHandler)completionHandler {
    ...
    [alertView showAnimated:NO
          ...
          completionHandler:^(void) {
              ...
              BOOL cancelButtonSelf = [YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self] && self.cancelButtonTitle;
              BOOL cancelButtonNext = [YYUIAlertViewHelper isCancelButtonSeparateForAlertView:alertView] && alertView.cancelButtonTitle;
...
- (void)transitionToAlertView:(YYUIAlertView *)alertView {
...
- (void)subviewsValidateWithSize:(CGSize)size {
    ...
    if (!self.isExists) {
        ...
        if (self.message) {
            ...
            else if (self.style == YYUIAlertViewStyleActionSheet) {
        ...
        if (self.innerView) {
        ...
        else if (self.type == YYUIAlertViewTypeActivityIndicator || self.type == YYUIAlertViewTypeProgressView) {
            if (self.type == YYUIAlertViewTypeActivityIndicator) {
            ...
            else if (self.type == YYUIAlertViewTypeProgressView) {
        ...
        else if (self.type == YYUIAlertViewTypeTextFields) {
            ...
            for (NSUInteger i = 0; i < self.numberOfTextFields; i++) {
                ...
                YYUIAlertViewTextField *textField = [YYUIAlertViewTextField new];
        ...
        if ([YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self] && self.cancelButtonTitle) {
            self.shadowCancelView = [YYUIAlertViewShadowView new];
        ...
        if (self.cancelButtonTitle && ![YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self]) {
            numberOfButtons++;
        }
        ...
        if (numberOfButtons) {
            if (!self.isOneRowOneButton &&
                ((self.style == YYUIAlertViewStyleAlert && numberOfButtons < 4) ||
                 (self.style == YYUIAlertViewStyleActionSheet && numberOfButtons == 1))) {
                    ...
                    if (self.destructiveButtonTitle && !showTable) {
                        self.destructiveButton = [YYUIAlertViewButton new];
                    ...
                    if (self.cancelButtonTitle && ![YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self] && !showTable) {
                        [self cancelButtonInit];
                    ...
                    if (self.buttonTitles.count > 0 && !showTable) {
                        ...
                        self.firstButton = [YYUIAlertViewButton new];
                        ...
                        if (self.buttonTitles.count > 1 && !showTable) {
                            ...
                            self.secondButton = [YYUIAlertViewButton new];
                            ...
                            if (self.buttonTitles.count > 2 && !showTable) {
                                ...
                                self.thirdButton = [YYUIAlertViewButton new];
                    ...
                    if (!showTable) {
                        ...
                        if (self.cancelButton && ![YYUIAlertViewHelper isCancelButtonSeparateForAlertView:self]) {
                        ...
                        if (offsetY) {
                            ...
                            CGRect separatorHorizontalViewFrame = CGRectMake(0.0, offsetY + self.innerMarginHeight, width, YYUIAlertViewHelper.separatorHeight);
                        ...
                        if (secondButton) {
                            secondButtonFrame = CGRectMake(CGRectGetMinX(firstButtonFrame) + CGRectGetWidth(firstButtonFrame) + YYUIAlertViewHelper.separatorHeight,
                                                           offsetY,
                                                           (width / numberOfButtons) - YYUIAlertViewHelper.separatorHeight,
                                                           self.buttonsHeight);
                            ...
                            if (thirdButton) {
                                thirdButtonFrame = CGRectMake(CGRectGetMinX(secondButtonFrame) + CGRectGetWidth(secondButtonFrame) + YYUIAlertViewHelper.separatorHeight,
                                                              offsetY,
                                                              (width / numberOfButtons) - YYUIAlertViewHelper.separatorHeight,
                                                              self.buttonsHeight);
            ...
            if (showTable) {
                ...
                [self.tableView registerClass:[YYUIAlertViewCell class] forCellReuseIdentifier:@"cell"];
                ...
                if (!offsetY) {
                    ...
                    CGRect separatorTitleViewFrame = CGRectMake(0.0, 0.0, width, YYUIAlertViewHelper.separatorHeight);
...
- (void)layoutValidateWithSize:(CGSize)size {
    ...
    if (self.windowLevel == YYUIAlertViewWindowLevelBelowStatusBar) {
    ...
    if (self.style == YYUIAlertViewStyleActionSheet && ![YYUIAlertViewHelper isPadAndNotForceForAlertView:self]) {
...
- (void)cancelAction:(id)sender {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewCancelNotification object:self userInfo:nil];
    ...
    if (self.dismissOnAction) {
        [self dismissAnimated:self.shouldDismissAnimated completionHandler:^{
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewDidDismissAfterCancelNotification object:self userInfo:nil];
        }];
    }
}
...
- (void)destructiveAction:(id)sender {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewDestructiveNotification object:self userInfo:nil];
    ...
    if (self.dismissOnAction) {
        [self dismissAnimated:self.shouldDismissAnimated completionHandler:^{
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewDidDismissAfterDestructiveNotification object:self userInfo:nil];
        }];
    }
}
...
- (void)actionActionAtIndex:(NSUInteger)index title:(NSString *)title {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewActionNotification
                                                        object:self
    ...
    if (self.dismissOnAction) {
        [self dismissAnimated:self.shouldDismissAnimated completionHandler:^{
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewDidDismissAfterActionNotification
                                                                object:self
                                                              userInfo:@{@"title": title,
                                                                         @"index": @(index)}];
        }];
...
- (void)willShowCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewWillShowNotification object:self userInfo:nil];
}
...
- (void)didShowCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewDidShowNotification object:self userInfo:nil];
}
...
- (void)willDismissCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewWillDismissNotification object:self userInfo:nil];
}
...
- (void)didDismissCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYUIAlertViewDidDismissNotification object:self userInfo:nil];
}

#pragma mark - Helpers

- (BOOL)isAlertViewValid:(YYUIAlertView *)alertView {
    NSAssert(alertView.isInitialized, @"You need to use one of \"- initWith...\" or \"+ alertViewWith...\" methods to initialize YYUIAlertView");
...
- (CGFloat)innerMarginHeight {
    return self.style == YYUIAlertViewStyleAlert ? 16.0 : 12.0;
}
...
@implementation YYUIAlertView (Deprecated)
