...
#import "YYUIAlertViewButtonProperties.h"
#import "YYUIAlertViewShared.h"

@class YYUIAlertView;
@protocol YYUIAlertViewDelegate;

#pragma mark - Constants

extern NSString * _Nonnull const YYUIAlertViewWillShowNotification;
extern NSString * _Nonnull const YYUIAlertViewDidShowNotification;

extern NSString * _Nonnull const YYUIAlertViewWillDismissNotification;
extern NSString * _Nonnull const YYUIAlertViewDidDismissNotification;

extern NSString * _Nonnull const YYUIAlertViewActionNotification;
extern NSString * _Nonnull const YYUIAlertViewCancelNotification;
extern NSString * _Nonnull const YYUIAlertViewDestructiveNotification;

extern NSString * _Nonnull const YYUIAlertViewDidDismissAfterActionNotification;
extern NSString * _Nonnull const YYUIAlertViewDidDismissAfterCancelNotification;
extern NSString * _Nonnull const YYUIAlertViewDidDismissAfterDestructiveNotification;

/** You can use this notification to add some custom animations */
extern NSString * _Nonnull const YYUIAlertViewShowAnimationsNotification;
/** You can use this notification to add some custom animations */
extern NSString * _Nonnull const YYUIAlertViewDismissAnimationsNotification;

extern NSString * _Nonnull const kYYUIAlertViewAnimationDuration;

#pragma mark - Types

typedef void (^ _Nullable YYUIAlertViewCompletionHandler)(void);
typedef void (^ _Nullable YYUIAlertViewHandler)(YYUIAlertView * _Nonnull alertView);
typedef void (^ _Nullable YYUIAlertViewActionHandler)(YYUIAlertView * _Nonnull alertView, NSUInteger index, NSString * _Nullable title);
typedef void (^ _Nullable YYUIAlertViewTextFieldsSetupHandler)(UITextField * _Nonnull textField, NSUInteger index);
typedef void (^ _Nullable YYUIAlertViewAnimationsBlock)(YYUIAlertView * _Nonnull alertView, NSTimeInterval duration);

typedef NS_ENUM(NSUInteger, YYUIAlertViewStyle) {
    YYUIAlertViewStyleAlert       = 0,
    YYUIAlertViewStyleActionSheet = 1
};

typedef NS_ENUM(NSUInteger, YYUIAlertViewWindowLevel) {
    YYUIAlertViewWindowLevelAboveStatusBar = 0,
    YYUIAlertViewWindowLevelBelowStatusBar = 1
};

#pragma mark -

@interface YYUIAlertView : NSObject <UIAppearance>
...
@property (assign, nonatomic, readonly) YYUIAlertViewStyle style;

/** Default is YYUIAlertViewWindowLevelAboveStatusBar */
@property (assign, nonatomic) YYUIAlertViewWindowLevel windowLevel UI_APPEARANCE_SELECTOR;
...
/**
 Default:
 if (style == YYUIAlertViewStyleAlert || iOS < 9.0) then 44.0
 else 56.0
 */
...
/**
 Offset between cancel button and main view when style is YYUIAlertViewStyleActionSheet
 Default is 8.0
 */
...
/**
 Default:
 if (style == YYUIAlertViewStyleAlert) then 280.0
...
/**
 Only if (style == YYUIAlertViewStyleAlert)
 Default is 1.2
 */
...
/**
 Default:
 if (style == YYUIAlertViewStyleAlert) then UIColor.blackColor
...
/**
 Default:
 if (style == YYUIAlertViewStyleAlert) then [UIFont boldSystemFontOfSize:18.0]
...
@property (copy, nonatomic) YYUIAlertViewHandler willShowHandler;
/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewHandler didShowHandler;

/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewHandler willDismissHandler;
/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewHandler didDismissHandler;

/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewActionHandler actionHandler;
/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewHandler cancelHandler;
/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewHandler destructiveHandler;

/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewActionHandler didDismissAfterActionHandler;
/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewHandler didDismissAfterCancelHandler;
/** To avoid retain cycle, do not forget about weak reference to self */
@property (copy, nonatomic) YYUIAlertViewHandler didDismissAfterDestructiveHandler;

/**
 You can use this block to add some custom animations
 To avoid retain cycle, do not forget about weak reference to self
 */
@property (copy, nonatomic, nullable) YYUIAlertViewAnimationsBlock showAnimationsBlock;
/**
 You can use this block to add some custom animations
 To avoid retain cycle, do not forget about weak reference to self
 */
@property (copy, nonatomic, nullable) YYUIAlertViewAnimationsBlock dismissAnimationsBlock;

#pragma mark - Delegate

@property (weak, nonatomic, nullable) id <YYUIAlertViewDelegate> delegate;
...
- (void)transitionToAlertView:(nonnull YYUIAlertView *)alertView;

- (void)setProgress:(float)progress progressLabelText:(nullable NSString *)progressLabelText;

- (void)setButtonPropertiesAtIndex:(NSUInteger)index handler:(void(^ _Nonnull)(YYUIAlertViewButtonProperties * _Nonnull properties))handler;
...
@protocol YYUIAlertViewDelegate <NSObject>

@optional

- (void)alertViewWillShow:(nonnull YYUIAlertView *)alertView;
- (void)alertViewDidShow:(nonnull YYUIAlertView *)alertView;

- (void)alertViewWillDismiss:(nonnull YYUIAlertView *)alertView;
- (void)alertViewDidDismiss:(nonnull YYUIAlertView *)alertView;

- (void)alertView:(nonnull YYUIAlertView *)alertView clickedButtonAtIndex:(NSUInteger)index title:(nullable NSString *)title;
- (void)alertViewCancelled:(nonnull YYUIAlertView *)alertView;
- (void)alertViewDestructed:(nonnull YYUIAlertView *)alertView;

- (void)alertView:(nonnull YYUIAlertView *)alertView didDismissAfterClickedButtonAtIndex:(NSUInteger)index title:(nullable NSString *)title;
- (void)alertViewDidDismissAfterCancelled:(nonnull YYUIAlertView *)alertView;
- (void)alertViewDidDismissAfterDestructed:(nonnull YYUIAlertView *)alertView;

/** You can use this method to add some custom animations */
- (void)showAnimationsForAlertView:(nonnull YYUIAlertView *)alertView duration:(NSTimeInterval)duration;
/** You can use this method to add some custom animations */
- (void)dismissAnimationsForAlertView:(nonnull YYUIAlertView *)alertView duration:(NSTimeInterval)duration;
